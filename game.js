window.addEventListener('DOMContentLoaded', () => {
    ...
    window.startGame = function() {
        if (!gameRunning) {
            ...
            sounds.gameStart.play().catch(e => console.log('Audio play failed:', e));/* chained catch methods on sound play calls */
    ...
    function attemptCollect() {
        ...
        const collectDistance = 60; // Increased collection distance
         ...
         /* Iterate backwards through toys array to safely remove elements during iteration */
         /* Forward loops skip elements because array indices shift when items are removed */
